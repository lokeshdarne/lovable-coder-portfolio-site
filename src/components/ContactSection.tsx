...
const ContactSection = () => {
  ...
  return <section id="contact" className="dark-glass-section relative overflow-hidden">
              ...
              <div className="space-y-8 flex-1">
                <div className="flex items-start group">
                  ...
                  <div>
                    ...
                    <a href="mailto:lokeshdarne@gmail.com" className="text-gray-300 hover:text-purple-400 transition-colors duration-300 text-lg">
                ...
                <div className="flex items-start group">
                  ...
                  <div>
                    ...
                    <a href="tel:+919960721074" className="text-gray-300 hover:text-blue-400 transition-colors duration-300 text-lg">
                      +91 9960721074
                    </a>
                  </div>
                </div>
            ...
            <div className="glass-panel p-8 h-full flex flex-col">
              ...
              <form onSubmit={handleSubmit} className="space-y-6 flex-1 flex flex-col">
                <div>
                  ...
                  <input type="text" id="name" name="name" value={formData.name} onChange={handleChange} className="w-full px-4 py-3 glass-card text-white placeholder-gray-400 border-0 focus:ring-2 focus:ring-purple-400 focus:outline-none transition-all duration-300 text-lg" placeholder="Enter your name" required />
                </div>
                ...
                <div>
                  ...
                  <input type="email" id="email" name="email" value={formData.email} onChange={handleChange} className="w-full px-4 py-3 glass-card text-white placeholder-gray-400 border-0 focus:ring-2 focus:ring-purple-400 focus:outline-none transition-all duration-300 text-lg" placeholder="Enter your email" required />
                </div>
                ...
                <div className="flex-1 flex flex-col">
                  ...
                  <textarea id="message" name="message" rows={6} value={formData.message} onChange={handleChange} className="w-full px-4 py-3 glass-card text-white placeholder-gray-400 border-0 focus:ring-2 focus:ring-purple-400 focus:outline-none transition-all duration-300 resize-none text-lg flex-1" placeholder="Write your message here..." required></textarea>
                </div>
                
                <Button type="submit" disabled={isSubmitting} className="w-full bg-gradient-to-r from-purple-600 to-blue-600 hover:from-purple-700 hover:to-blue-700 text-white font-semibold py-4 text-lg rounded-xl pulse-glow border-0 transition-all duration-300 hover:scale-105 mt-auto">
