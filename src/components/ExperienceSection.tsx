...
const ExperienceSection = () => {
  ...
  return (
    <section id="experience" className="py-20 dark-glass-section">
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute top-1/3 -left-32 w-64 h-64 bg-cyan-500/10 rounded-full blur-3xl floating-animation" />
        <div className="absolute bottom-1/3 -right-32 w-64 h-64 bg-purple-500/10 rounded-full blur-3xl floating-animation" style={{animationDelay: '2s'}} />
      </div>
