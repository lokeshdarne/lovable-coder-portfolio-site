    ...
    <section id="hero" className="min-h-screen flex items-center justify-center relative overflow-hidden">
      ...
      <div className="section-container relative z-10">
        <div className="flex flex-col items-center text-center max-w-5xl mx-auto space-content">
          <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl font-bold mb-6 sm:mb-8 animate-fade-in-up leading-tight tracking-wide font-sans">
            <span className="block text-white">LOKESH</span>
            <span className="block gradient-text">DARNE</span>
          </h1>
          
          <h2 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl xl:text-5xl font-medium text-gray-300 mb-8 sm:mb-12 lg:mb-16 animate-fade-in-up animation-delay-100 font-heading leading-relaxed tracking-tight">
